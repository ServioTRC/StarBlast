...
class Constantes {
    ...
    static final short MASK_PLAYER = CATEGORY_ENEMY | CATEGORY_BULLET_ENEMY | CATEGORY_BORDERS | CATEGORY_BULLET;
    static final short MASK_ENEMY = CATEGORY_PLAYER | CATEGORY_ENEMY | CATEGORY_BULLET | CATEGORY_BULLET_ENEMY;
    static final short MASK_BULLET = CATEGORY_ENEMY | CATEGORY_BULLET_ENEMY | CATEGORY_BORDERS | CATEGORY_PLAYER;
    static final short MASK_BULLET_ENEMY = CATEGORY_PLAYER | CATEGORY_BULLET | CATEGORY_BORDERS | CATEGORY_ENEMY;
