...
public class ShipEnemyBoss extends ShipEnemy {
    ...
    private static final int MISSILE_DAMAGE = 30;
    ...
    protected void shoot(){
        ...
        switch (random.nextInt(10)){
            ...
            case 8:
                ...
                break;
            case 9:
                new Missile(gunPosition,world,angle,enemy,MISSILE_DAMAGE,batch,Constant.MANAGER.get("GameScreen/MissileSpriteEnemy.png",Texture.class),10);
                /*
